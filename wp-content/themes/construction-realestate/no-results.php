...
<header role="banner">
	<h2 class="entry-title"><?php esc_html_e( 'Nothing Found', 'construction-realestate' ); ?></h2>
</header>
...
<?php elseif ( is_search() ) : ?>
	<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'construction-realestate' ); ?></p><br />
		<?php get_search_form(); ?>
<?php else : ?>
