...
function construction_realestate_widgets_init() {
	...
	register_sidebar( array(
		...
		'description'   => __( 'Appears on footer', 'construction-realestate' ),
		'id'            => 'footer-1',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
...
function construction_realestate_scripts() {
	...
	$custom_css = '
		p,span{
		    ...
		    font-size: '.esc_html($construction_realestate_paragraph_font_size).';
		}
		a{
		...
		h1{
		    ...
		    font-size: '.esc_html($construction_realestate_h1_font_size).'!important;
		}
		h2{
		    ...
		    font-size: '.esc_html($construction_realestate_h2_font_size).'!important;
		}
		h3{
		    ...
		    font-size: '.esc_html($construction_realestate_h3_font_size).'!important;
		}
		h4{
		    ...
		    font-size: '.esc_html($construction_realestate_h4_font_size).'!important;
		}
		h5{
		    ...
		    font-size: '.esc_html($construction_realestate_h5_font_size).'!important;
		}
		h6{
		    ...
		    font-size: '.esc_html($construction_realestate_h6_font_size).'!important;
		}
		';
	wp_add_inline_style('construction-realestate-basic-style', $custom_css);
...
define('CONSTRUCTION_REALESTATE_PRO_DOC','https://buywptemplates.com/demo/docs/construction-realestate-pro/','construction-realestate');
define('CONSTRUCTION_REALESTATE_FREE_DOC','https://buywptemplates.com/demo/docs/free-construction-realestate/','construction-realestate');
define('CONSTRUCTION_REALESTATE_PRO_SUPPORT','https://www.buywptemplates.com/support/','construction-realestate');
...
define('CONSTRUCTION_REALESTATE_CREDIT','https://www.buywptemplates.com/themes/free-construction-real-estate-wordpress-theme/','construction-realestate');
