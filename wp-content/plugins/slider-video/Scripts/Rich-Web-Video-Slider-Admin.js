		...
		if(code.indexOf('https://www.youtube.com/')>0)
		{
			if(code.indexOf('list')>0 || code.indexOf('index')>0)
			{
				if(code.indexOf('embed')>0)
				{
					...
					jQuery('#Rich_Web_Vid_ImSrc_2').val('https://img.youtube.com/vi/'+Rich_Web_Codes3[1]+'/mqdefault.jpg');
					jQuery('#Rich_Web_Vid_Vid_1').val('https://www.youtube.com/watch?v='+Rich_Web_Codes3[1]);

					if(jQuery('#Rich_Web_Vid_Src_2').val().length>0){ clearInterval(RWIntervId); jQuery('#Rich_Web_Vid_Src_1').val(''); }
				}
				else
				{
					...
					jQuery('#Rich_Web_Vid_ImSrc_2').val('https://img.youtube.com/vi/'+Rich_Web_Code_Src[0]+'/mqdefault.jpg');
			...
			else if(code.indexOf('embed')>0)
			{
				...
				else
				{
					...
					jQuery('#Rich_Web_Vid_ImSrc_2').val('https://img.youtube.com/vi/'+Rich_Web_Im_Src[1]+'/mqdefault.jpg');
...
function Rich_Web_Upload_Image()
{
	var RWIntervId = setInterval(function(){
		...
		if(code.indexOf('img')>0)
		{
			...
			if(jQuery('#Rich_Web_Vid_ImSrc_2').val().length>0){ jQuery('#Rich_Web_Vid_ImSrc_1').val(''); clearInterval(RWIntervId); }
		}
	},100)
}
