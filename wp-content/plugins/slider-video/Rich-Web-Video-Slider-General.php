		...
		<div class='Rich_Web_VSlider_Opt_Table_Data_2'>
			...
			<table class='Rich_Web_VSlider_Save_Table_2' id="Rich_Web_VSlider_Save_Table_2_1">
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="" id="Rich_Web_VS_CP_NO" name="Rich_Web_VS_CP_NO" min="0" max="100">
			...
			<table class='Rich_Web_VSlider_Save_Table_2 RWeb_VSlider_Save_Table_2' id="Rich_Web_VSlider_Save_Table_2_2">
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="" id="Rich_Web_VS_SS_PT" name="Rich_Web_VS_SS_PT" min="100" max="1000" step="100">
			...
			<table class='Rich_Web_VSlider_Save_Table_2 RWeb_VSlider_Save_Table_2' id="Rich_Web_VSlider_Save_Table_2_4">
				...
				<tr>
					...
					<td>
						<input type="text" class="Rich_Web_VS_Color" name="" id="Rich_Web_VC_Link_Hov_Border_Color" value=""/>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">
							<input class="range-slider__range" type="range" value="" id="Rich_Web_VCCP_LT_FS" name="Rich_Web_VCCP_LT_FS" min="8" max="25">
