<?php
	...
	*/
	...
	function Rich_Web_Video_Slider_Admin_Menu() 
	{
		...
		add_menu_page('Rich-Web Video Slider Admin' . $complete_url,'Video Slider','manage_options','Rich-Web Video Slider Admin' . $complete_url,'Manage_Rich_Web_Video_Slider_Admin',plugins_url('/Images/admin.png',__FILE__));
 		add_submenu_page('Rich-Web Video Slider Admin' . $complete_url, 'Rich-Web Video Slider Admin', 'Slider Manager', 'manage_options', 'Rich-Web Video Slider Admin' . $complete_url, 'Manage_Rich_Web_Video_Slider_Admin');
		add_submenu_page('Rich-Web Video Slider Admin' . $complete_url, 'Rich-Web Video Slider General', 'Slider Options', 'manage_options', 'Rich-Web Video Slider General' . $complete_url, 'Manage_Rich_Web_Video_Slider_General');
		add_submenu_page('Rich-Web Video Slider Admin' . $complete_url, 'Rich-Web Video Slider Products', 'Our Products', 'manage_options', 'Rich-Web Video Slider Products', 'Manage_Rich_Web_Video_Slider_Products');
	}
	...
	register_activation_hook(__FILE__,'Ric_Web_Video_Slider_activate');
	function Ric_Web_Video_Slider_activate()
	{
