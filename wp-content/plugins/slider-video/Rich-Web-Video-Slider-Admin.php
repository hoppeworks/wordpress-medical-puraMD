<?php
	...
	if($_SERVER["REQUEST_METHOD"]=="POST")
	{
		...
		{	
			...
			$Rich_Web_VSlider_Vid_Title = array();
			$Rich_Web_VSlider_Add_Desc  = array();
			$Rich_Web_VSldier_Add_Img   = array();
			$Rich_Web_VSldier_Add_Vid   = array();
			$Rich_Web_VSldier_Add_Src   = array();
			$Rich_Web_VSldier_Add_Link  = array();
			$Rich_Web_VSldier_Add_ONT   = array();
...
<form method="POST" enctype="multipart/form-data">
	...
	<div style="position: relative; width: 100%; right: 1%; height: 50px;">
		<input type='button' class='Rich_Web_VSlider_Add' value='New Slider' onclick='RichWeb_Video_Slider_Add(<?php echo $Rich_Web_VS_IDn+1;?>)'/>
	...
	<div class='Table_Data_Rich_Web_VS_Content'>
		<div class='Table_Data_VS_Rich_Web1'>
			...
			<?php for($i=0;$i<count($Rich_Web_VS_Dat);$i++){ ?>
				<tr class='Rich_Web_VSlider_Tit_Table_Tr2'>
					<td><?php echo $i+1; ?></td>
					<td><?php echo $Rich_Web_VS_Dat[$i]->Slider_Title;?></td>
					<td><?php echo $Rich_Web_VS_Dat[$i]->Slider_Type;?></td>
					<td><?php echo $Rich_Web_VS_Dat[$i]->Slider_Video_Quantity; ?></td>
					<td onclick="Rich_Web_VS_Copy(<?php echo $Rich_Web_VS_Dat[$i]->id;?>)"><i class='Rich_Web_VS_Files rich_web rich_web-files-o'></i></td>
					<td onclick="Rich_Web_VS_Edit(<?php echo $Rich_Web_VS_Dat[$i]->id;?>)"><i class='Rich_Web_VS_Pencil rich_web rich_web-pencil'></i></td>
					<td onclick="Rich_Web_VS_Del(<?php echo $Rich_Web_VS_Dat[$i]->id;?>)"><i class='Rich_Web_VS_Delete rich_web rich_web-trash'></i></td>
				</tr>
			<?php } ?>
			</table>
		</div>
		<div class='Table_Data_VS_Rich_Web2'>
			<table class="Rich_Web_VS_ShortTable" style="display: table;float:right;">
				...
				<tr>
					<td class="Rich_Web_VSlider_ID">[Rich_Web_Video id="1"]</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="Rich_Web_VSlider_ID_1">&lt;?php echo do_shortcode("[Rich_Web_Video id="1"]");?&gt;</td>
				</tr>
			</table>
					...
					<td style='width:50%'>
						<select class='Rich_Web_VSlider_Input Rich_Web_VSlider_Type' name='Video_Slider_Type'>
							<?php for($i=0;$i<count($Rich_Web_VS_Eff);$i++){ ?>
								<option value='<?php echo $Rich_Web_VS_Eff[$i]->slider_vid_name;?>'><?php echo $Rich_Web_VS_Eff[$i]->slider_vid_name;?></option>
							<?php }?>
						</select>
					</td>
				</tr>
